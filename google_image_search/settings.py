...
SETTINGS_JSON = {
    ...
    "webdriver_path": "/usr/local/bin/chromedriver.exe",  # webdriver 的路径，如果webdriver在python Scripts下面，可以不声明，否则其他时候必须声明
    "brower": "chrome",  # 或者 chrome
    "profile_path": "/Users/jasper/Library/Application Support/Google/Chrome/Default",  # 是一个文件夹
    "mirror": False  # 是否使用镜像网站
}
